...
public abstract class Controler implements ActionListener, Controler_Interface{
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*si l'�venement n'est pas du Service courrant*/
		...
		/* Si l'�venement est du Service courant ou si on a changer de modul*/
		if(!sortie)
		{
			/* on redirige le message vers le Service concern� et on r�cupere l'abstracMessage de l'action*/
